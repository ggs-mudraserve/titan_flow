defmodule TitanFlowWeb do
  ...
  def controller do
    quote do
      ...
      use Gettext, backend: TitanFlowWeb.Gettext
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {TitanFlowWeb.Layouts, :app}
  ...
  defp html_helpers do
    quote do
      ...
      # Core UI components
      import TitanFlowWeb.CoreComponents
